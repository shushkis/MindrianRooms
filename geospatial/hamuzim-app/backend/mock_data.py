...
MOCK_AI_SUMMARY_HE = (
    "על בסיס ראיות מתצלומי אוויר ולוויין המשתרעות בין השנים 1959 ל-2024, חלקה זו מראה "
    "פעילות חקלאית רציפה לאורך 65 שנים. אותות עיבוד נוכחים ב-6 מתוך 8 תקופות תצפית. "
    "הפחתת האות בשנת 2003 תואמת למחזור תרדמת מטע זיתים ולא לנטישה – דפוס שאושר על ידי "
    "ההתאוששות בשנת 2012. רישומים קדסטריים מהתקופה העות'מאנית תומכים בתיאור הגבול שסופק "
    "על ידי המבקש. חוזק ראייתי: גבוהה. פעולה מומלצת: מעבר להליך רישום מלא."
)
